...
class OrderStatusTile extends StatefulWidget {
  ...
  OrderStatusTile({this.noOfButtons,this.images,this.currentState,this.statusChangeCallback,this.isButtonClickable = true});
...
class _OrderStatusTileState extends State<OrderStatusTile> {
  ...
  getStatusButtons(int index) =>  Container(
