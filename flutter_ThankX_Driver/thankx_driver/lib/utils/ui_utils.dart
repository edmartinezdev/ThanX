...
import '../control/progress_dialog.dart';
...
class UIUtills {
  ...
  final double _refrenceScreenHeight = 812;
  final double _refrenceScreenWidth = 375;
  ...
  static Future<void> showSnakBar(BuildContext context, String message) {
  ...
  TextStyle getTextStyle({
    String fontName = 'SfCompactRegular',
    int fontsize = 14,
    Color color,
    bool isChangeAccordingToDeviceSize = true,
    double characterSpacing, double lineSpacing
  }) {
...
//region TextStyle
  ...
  Widget setCommonSizeBox({bool isHeight = true, double value = 0.0}) {
    return isHeight ? SizedBox(height: UIUtills().getProportionalWidth(value)) : SizedBox(width: UIUtills().getProportionalWidth(value));
  }
