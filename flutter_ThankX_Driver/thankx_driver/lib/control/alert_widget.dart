  ...
  Widget get titleWidget {
    ...
    if (Platform.isIOS) {
      if (mainTitle != null && mainTitle.length > 0) {
        final style = UIUtills().getTextStyle(fontName: AppFont.sfProTextSemibold, fontsize: 16, characterSpacing: 0.68);
        var titleW = Align(
          child: Text(
            mainTitle,
            style: style,
      ...
      if (mainTitle != null && mainTitle.length > 0) {
        final style = UIUtills().getTextStyle(
            fontName: AppFont.sfProTextRegular, fontsize: 16, characterSpacing: 0.68);
        var titleW = Align(
          child: Text(
            mainTitle,
            style: style,
      ...
      if (Platform.isIOS) {
        ...
        button = CupertinoDialogAction(
            isDestructiveAction: str.toLowerCase() ==
                AppTranslations.globalTranslations.buttonLogin.toLowerCase(),
            child: Text(
              str,
              style: style,
            ),
